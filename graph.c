...
void drawWorld (unsigned short *currentWorld, unsigned short *newWorld, SDL_Renderer* renderer,
...
void saveImage (SDL_Renderer* renderer, char* fileName, int screenWidth, int screenHeight){
